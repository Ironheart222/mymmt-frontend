...
export default function SignInSide() {
  ...
  React.useEffect(() => {
    Router.replace("/"); //Redirect to Login page as this signup page not used for signup
                ...
                <Grid container spacing={1}>
                  ...
                  <Grid item md={12} sm={12} xs={12}>
                    ...
                    <TextField
                      ...
                      error={
                        formError &&
                        (formError.email || formError.confirm_email)
                          ? true
                          : false
                      }
                  ...
                  <Grid item md={12} sm={12} xs={12}>
                    ...
                    <TextField
                      ...
                      autoFocus
                      error={
                        formError && formError.confirm_email ? true : false
                      }
                    ...
                    <FormControlLabel
                      control={
                        <Checkbox
                          ...
                          onChange={handleChange("term_condition")}
